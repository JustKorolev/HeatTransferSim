...
class GraphVisualizerModelTests(unittest.TestCase):
    ...
    def test_role_pairing_reuses_closest_sensor_after_unique_assignment(self) -> None:
        model = ThermalGraphModel(metadata=GraphMetadata(graph_name="sensor_reuse_pairing"))
    ...
    def test_manual_pairing_allows_sensor_reuse(self) -> None:
        model = ThermalGraphModel(metadata=GraphMetadata(graph_name="manual_sensor_reuse"))
        heater_a = NodeProperties.with_material(1, (0, 0, 0), material="copper")
        heater_a.is_heater = True
        heater_b = NodeProperties.with_material(2, (1, 0, 0), material="copper")
        heater_b.is_heater = True
